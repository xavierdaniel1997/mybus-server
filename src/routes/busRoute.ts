...
import { createBusController, getAllBuses, getBusDetailController, updateBusController } from '../controller/busController';
...
router.get("/all-buses", isAuth, isAdmin, getAllBuses);        
